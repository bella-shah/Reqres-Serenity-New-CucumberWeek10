...
public class MyStepdefs {
    ...
    @And("^I verify if forth data's first_name is Rachel$")
    public void iVerifyIfForthDataSFirst_nameIsRachel() {
        response = usersSteps.getAllUserFromPageTwo();
